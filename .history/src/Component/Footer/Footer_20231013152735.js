  ...
  function PortalModal(props) {
    return (
      ...
      >
        ...
        <Modal.Body>
        An "Invoicing Client Portal" is a secure and user-friendly online platform or interface that
businesses use to interact with their clients for invoicing and related financial transactions. It
streamlines the invoicing process, provides clients with easy access to billing information, and
enhances overall communication and transparency between businesses and their clients. Here's

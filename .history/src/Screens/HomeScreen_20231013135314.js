...
const HomeScreen = () => {
  ...
  return (
    <>
      <DescModal show={modalShow} onHide={() => setModalShow(false)} title={title} desc={desc} />
      <Navbar />
      <Hero />
      <Banner />
      ...
      <div className="elipse">
        <div>
          ...
          >
           End-to-End Accounting" refers to the comprehensive process of recording, summarizing, and
reporting financial transactions within an organization from start to finish. It encompasses all
aspects of financial management and plays a crucial role in ensuring the accuracy,
transparency, and compliance of an organization's financial activities. Here's a detailed
breakdown of the content related to end-to-end accounting:

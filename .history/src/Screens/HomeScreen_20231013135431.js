      ...
      <div className="elipse">
        <div>
          ...
          >
            ...
            recording, summarizing... <p style={{font-size: 2rem; text-align: center; margin-top: 3%; font-weight: 400; margin-bottom: 1%; color: rgb(76, 104, 245)}}>Learn more <i class="fa-solid fa-arrow-right"></i></p>
          </p>
        </div>
        <div>
          <img

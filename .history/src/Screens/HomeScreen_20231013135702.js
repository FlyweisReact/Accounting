...
const HomeScreen = () => {
  ...
  const endDesc = "End-to-End Accounting refers to the comprehensive process of recording, summarizing, and reporting financial transactions within an organization from start to finish. It encompasses all aspects of financial management and plays a crucial role in ensuring the accuracy, transparency, and compliance of an organization's financial activities. Here's a detailed breakdown of the content related to end-to-end accounting: <br /> 1. Introduction to Accounting: • Define accounting and its importance in business. • Explain the role of accounting in decision-making.

      ...
      >
        ...
        <Modal.Body>
          ...
          <ul>
            ...
            <li>  Differentiate between financial accounting and managerial accounting.</li>
          </ul>
          <strong>2. Accounting Principles and Standards:</strong>
          <ul>
            <li> Discuss generally accepted accounting principles (GAAP) and international
financial reporting standards (IFRS).
</li>
            <li> Explain how these standards ensure consistency and comparability in financial
reporting. </li>
            <li>  Differentiate between financial accounting and managerial accounting.</li>
          </ul>
        </Modal.Body>

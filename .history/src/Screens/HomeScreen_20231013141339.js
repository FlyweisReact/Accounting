  ...
  function GstModal(props) {
    return (
      ...
      >
        ...
        <Modal.Body>
        GST (Goods and Services Tax) compliance services refer to the range of services provided by
professionals or organizations to help businesses comply with the GST regulations and
requirements in their respective countries. GST is a value-added tax that is levied on the supply
of goods and services, and its compliance involves various activities to ensure that businesses
meet their tax obligations accurately and on time. 
          <br />
          <br />
          <strong>1. Introduction to Accounting:</strong>
          <ul>

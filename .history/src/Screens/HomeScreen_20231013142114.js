    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          ...
          <ul>
            <li>
            Differentiate between industry-specific integrated platforms and general-purpose
platforms.
            </li>
            <li> Provide examples of well-known integrated platform solutions in different domains.</li>
          </ul>
          <strong>6. Recording Transactions:</strong>
          <ul>
            <li>

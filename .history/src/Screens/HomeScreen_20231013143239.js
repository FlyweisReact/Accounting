      ...
      >
        ...
        <Modal.Body>
          ...
          <ul>
            ...
            <li>GSTIN (GST Identification Number): Describe how individuals and businesses receive a
unique GSTIN upon registration, which is used for tax compliance and reporting.</li>
<li>Collecting GST: Explain the responsibilities of businesses in collecting GST from their
customers (contacts) when selling taxable goods or services.</li>
          </ul>
          <strong></strong>
          <ul>
            <li></li>

    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          ...
          <strong>3. Record Keeping and Documentation:
</strong>
          <ul>
            <li>Emphasize the importance of maintaining accurate records and documentation related
to GST transactions for both items and contacts</li>
<li>Explain the types of records that businesses need to keep, including invoices, receipts,
and GST returns.</li>
          </ul>
          <strong>4. Impact on Pricing and Cost Management:</strong>
          <ul>
            <li>Discuss how GST treatment can affect the pricing of items and services, as businesses
may need to factor in GST when setting prices.
</li>
<li></li>
          </ul>
        </Modal.Body>
